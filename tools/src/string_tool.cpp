...
void StringTool::SplitStringByToken(std::vector<std::string> &result, const std::string &origin, const std::string &token)
{
...
void StringTool::MP_Pattern_Relation(const std::string& pattern, int mpNext[])
{
...
void StringTool::MP(std::vector<int>& result, std::string pattern, std::string target)
{
...
void StringTool::KMP_Pattern_Relation(const std::string& pattern, int kmpNext[]) {
    // excute the relationship between chars in pattern
    unsigned int len = pattern.length();
    kmpNext[0] = -1;
    int pos = -1;
...
void StringTool::KMP(std::vector<int>& result, std::string pattern, std::string target) {
    int pattern_len = pattern.length();
    int target_len = target.length();
